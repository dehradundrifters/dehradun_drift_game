...
namespace Unity.Splines.Examples
{
    ...
    public class LoftRoadBehaviour : MonoBehaviour
    {
        ...
        // Function to update the MeshCollider
        void UpdateMeshCollider()
        {
            MeshCollider collider = GetComponent<MeshCollider>();
            if (collider != null)
            {
                collider.sharedMesh = null; // Reset to force update
                collider.sharedMesh = m_Mesh; // Assign the updated mesh
...
#endif
                    m_Widths.Add(new SplineData<float>() { DefaultValue = defaultwidth });
                }
            }
